...
def make_settings(runtime_dir: Path) -> Settings:
    return Settings(
        ...
        web_auth_session_secret="test-session-secret",
        web_auth_cookie_secure=False,
        web_auth_session_max_age_seconds=60 * 60,
        llm_provider="google",
        ...
        routing_llm_provider="google",
        routing_llm_model="gemini-test",
        routing_llm_temperature=0.2,
        routing_google_api_key="test-google-api-key",
        routing_minimax_api_key="test-minimax-api-key",
        routing_minimax_base_url="https://api.minimaxi.com/v1",
        routing_openai_api_key="test-openai-api-key",
        routing_openai_base_url="https://api.openai.com/v1",
        routing_llm_http_trust_env=False,
        routing_llm_overrides_present=False,
        assistant_request_parser_confidence_threshold=0.6,
        ...
        context_window_effective_window=None,
        context_window_warning_threshold=None,
        context_window_auto_compact_threshold=None,
        context_window_hard_block_threshold=None,
        context_window_auto_compact_enabled=True,
        context_window_auto_compact_preserved_tail_count=1,
        context_window_auto_compact_failure_limit=3,
        session_memory_enabled=True,
        session_memory_initialize_threshold_tokens=2_048,
        session_memory_update_growth_threshold_tokens=768,
